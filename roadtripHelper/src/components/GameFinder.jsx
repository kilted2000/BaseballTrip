...
const GameFinder = () => {
  ...
  return (
    <div className="bg-[url('./assets/stadium.jpg')] bg-cover bg-repeat-y h-full object-cover justify-center justify-items-center items-center flex flex-col h-dvh">
      <form
      ...
      >
          ...
          {results.map((result, index) => (
            ...
            <tbody >
              {/* display result component after click */}
